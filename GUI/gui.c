...
static uint8_t cvs_buf_background[LV_CANVAS_BUF_SIZE_TRUE_COLOR_ALPHA(MAX_X,MAX_Y)] __attribute__((section(".lvgl_ram")));
...
static uint8_t cvs_buf_hdng_panel[LV_CANVAS_BUF_SIZE_TRUE_COLOR_ALPHA(PANEL_HDNG_W,PANEL_HDNG_H)] __attribute__((section(".lvgl_ram")));
...
static uint8_t cvs_buf_speed_v[LV_CANVAS_BUF_SIZE_TRUE_COLOR_ALPHA(PANEL_VSPD_W,PANEL_VSPD_H)] __attribute__((section(".lvgl_ram")));
...
static uint8_t cvs_buf_pres[LV_CANVAS_BUF_SIZE_TRUE_COLOR_ALPHA(PANEL_PRES_W,PANEL_PRES_H)] __attribute__((section(".lvgl_ram")));
...
static uint8_t cvs_buf_msg_box[LV_CANVAS_BUF_SIZE_TRUE_COLOR_ALPHA(PANEL_MSG_W,PANEL_MSG_H)] __attribute__((section(".lvgl_ram")));
...
void gui_init(gui_state_t* state)
{
	...
	lv_canvas_set_buffer(cvs_background, cvs_buf_background, MAX_X, MAX_Y, LV_IMG_CF_TRUE_COLOR_ALPHA );
	...
	lv_canvas_set_buffer(cvs_hdng_panel, cvs_buf_hdng_panel, PANEL_HDNG_W, PANEL_HDNG_H, LV_IMG_CF_TRUE_COLOR_ALPHA);
	...
	lv_canvas_set_buffer(cvs_speed_v, cvs_buf_speed_v, PANEL_VSPD_W, PANEL_VSPD_H, LV_IMG_CF_TRUE_COLOR_ALPHA);
	...
	lv_canvas_set_buffer(cvs_pres, cvs_buf_pres, PANEL_PRES_W, PANEL_PRES_H, LV_IMG_CF_TRUE_COLOR_ALPHA);
	...
	lv_canvas_set_buffer(cvs_msg_box, cvs_buf_msg_box, PANEL_MSG_W, PANEL_MSG_H, LV_IMG_CF_TRUE_COLOR_ALPHA);
